...
set_property IOSTANDARD LVCMOS25 [get_ports {clkSelA[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {clkSelA[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {clkSelB[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {clkSelB[0]}]

set_property IOSTANDARD LVCMOS25 [get_ports {led[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {led[0]}]

set_property IOSTANDARD LVDS_25 [get_ports {dtmClkP[1]}]
set_property IOSTANDARD LVDS_25 [get_ports {dtmClkP[0]}]
set_property IOSTANDARD LVDS_25 [get_ports {dtmClkM[1]}]
set_property IOSTANDARD LVDS_25 [get_ports {dtmClkM[0]}]
...
set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks {ethRefClkP}] -group [get_clocks -hier -filter {name =~ */U_Eth10gGen.U_RceEthernet/GEN_10GBase.U_Eth/U_IpCore/U0/gt0_gtwizard_10gbaser_multi_gt_i/gt0_gtwizard_10gbaser_i/gtxe2_i/TXOUTCLK}]

set_clock_groups -asynchronous -group [get_clocks -include_generated_clocks {ethRefClkP}] -group [get_clocks -hier -filter {name =~ */U_Eth10gGen.U_RceEthernet/GEN_10GBase.U_Eth/U_IpCore/U0/gt0_gtwizard_10gbaser_multi_gt_i/gt0_gtwizard_10gbaser_i/gtxe2_i/RXOUTCLK}]
