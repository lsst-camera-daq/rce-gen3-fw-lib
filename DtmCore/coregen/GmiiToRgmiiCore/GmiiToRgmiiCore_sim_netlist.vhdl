...
-- Date        : Fri Nov  2 14:32:07 2018
-- Host        : lsst-daq03 running 64-bit Red Hat Enterprise Linux Server release 6.10 (Santiago)
-- Command     : write_vhdl -force -mode funcsim -rename_top GmiiToRgmiiCore -prefix
--               GmiiToRgmiiCore_ GmiiToRgmiiCore_sim_netlist.vhdl
-- Design      : GmiiToRgmiiCore
...
entity GmiiToRgmiiCore_GmiiToRgmiiCore_clocking is
  port (
...
end GmiiToRgmiiCore_GmiiToRgmiiCore_clocking;

architecture STRUCTURE of GmiiToRgmiiCore_GmiiToRgmiiCore_clocking is
...
GmiiToRgmiiCore_core_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_GmiiToRgmiiCore_reset_sync is
  port (
  ...
  attribute INITIALISE of GmiiToRgmiiCore_GmiiToRgmiiCore_reset_sync : entity is "2'b11";
  attribute dont_touch : string;
  attribute dont_touch of GmiiToRgmiiCore_GmiiToRgmiiCore_reset_sync : entity is "yes";
end GmiiToRgmiiCore_GmiiToRgmiiCore_reset_sync;

architecture STRUCTURE of GmiiToRgmiiCore_GmiiToRgmiiCore_reset_sync is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_MDIO_INTERFACE is
  port (
...
end GmiiToRgmiiCore_MDIO_INTERFACE;

architecture STRUCTURE of GmiiToRgmiiCore_MDIO_INTERFACE is
  ...
  attribute srl_bus_name of \SHIFT_REG_reg[10]_srl2___i_gmii_to_rgmii_i_MANAGEMENT_MDIO_INTERFACE_1_SHIFT_REG_reg_r_0\ : label is "U0/\i_gmii_to_rgmii_block/GmiiToRgmiiCore_core /\i_gmii_to_rgmii/i_MANAGEMENT/MDIO_INTERFACE_1/SHIFT_REG_reg ";
  attribute srl_name : string;
  attribute srl_name of \SHIFT_REG_reg[10]_srl2___i_gmii_to_rgmii_i_MANAGEMENT_MDIO_INTERFACE_1_SHIFT_REG_reg_r_0\ : label is "U0/\i_gmii_to_rgmii_block/GmiiToRgmiiCore_core /\i_gmii_to_rgmii/i_MANAGEMENT/MDIO_INTERFACE_1/SHIFT_REG_reg[10]_srl2___i_gmii_to_rgmii_i_MANAGEMENT_MDIO_INTERFACE_1_SHIFT_REG_reg_r_0 ";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_reset_sync is
  port (
    reset_out : out STD_LOGIC;
    ref_clk : in STD_LOGIC;
    reset_in : in STD_LOGIC
  );
end GmiiToRgmiiCore_reset_sync;

architecture STRUCTURE of GmiiToRgmiiCore_reset_sync is
  signal reset_sync_reg1 : STD_LOGIC;
  signal reset_sync_reg2 : STD_LOGIC;
  signal reset_sync_reg3 : STD_LOGIC;
  signal reset_sync_reg4 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_reset_sync_0 is
  port (
  ...
  attribute ORIG_REF_NAME of GmiiToRgmiiCore_reset_sync_0 : entity is "reset_sync";
end GmiiToRgmiiCore_reset_sync_0;

architecture STRUCTURE of GmiiToRgmiiCore_reset_sync_0 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_reset_sync_1 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of GmiiToRgmiiCore_reset_sync_1 : entity is "reset_sync";
end GmiiToRgmiiCore_reset_sync_1;

architecture STRUCTURE of GmiiToRgmiiCore_reset_sync_1 is
  signal \^reset_out\ : STD_LOGIC;
  signal reset_sync_reg1 : STD_LOGIC;
  signal reset_sync_reg2 : STD_LOGIC;
  signal reset_sync_reg3 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_reset_sync_2 is
  port (
    reset_out : out STD_LOGIC;
    CLK : in STD_LOGIC;
    reset_in : in STD_LOGIC
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of GmiiToRgmiiCore_reset_sync_2 : entity is "reset_sync";
end GmiiToRgmiiCore_reset_sync_2;

architecture STRUCTURE of GmiiToRgmiiCore_reset_sync_2 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_reset_sync_3 is
  port (
    reset_out : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of GmiiToRgmiiCore_reset_sync_3 : entity is "reset_sync";
end GmiiToRgmiiCore_reset_sync_3;

architecture STRUCTURE of GmiiToRgmiiCore_reset_sync_3 is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_sync_block is
  port (
...
end GmiiToRgmiiCore_sync_block;

architecture STRUCTURE of GmiiToRgmiiCore_sync_block is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_sync_block_5 is
  port (
    data_out : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of GmiiToRgmiiCore_sync_block_5 : entity is "sync_block";
end GmiiToRgmiiCore_sync_block_5;

architecture STRUCTURE of GmiiToRgmiiCore_sync_block_5 is
  signal data_sync1 : STD_LOGIC;
  signal data_sync2 : STD_LOGIC;
  signal data_sync3 : STD_LOGIC;
  signal data_sync4 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \GmiiToRgmiiCore_sync_block__parameterized1\ is
  port (
    data_out : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \GmiiToRgmiiCore_sync_block__parameterized1\ : entity is "sync_block";
end \GmiiToRgmiiCore_sync_block__parameterized1\;

architecture STRUCTURE of \GmiiToRgmiiCore_sync_block__parameterized1\ is
  signal data_sync1 : STD_LOGIC;
  signal data_sync2 : STD_LOGIC;
  signal data_sync3 : STD_LOGIC;
  signal data_sync4 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity \GmiiToRgmiiCore_sync_block__parameterized1_4\ is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of \GmiiToRgmiiCore_sync_block__parameterized1_4\ : entity is "sync_block";
end \GmiiToRgmiiCore_sync_block__parameterized1_4\;

architecture STRUCTURE of \GmiiToRgmiiCore_sync_block__parameterized1_4\ is
  signal data_sync1 : STD_LOGIC;
  signal data_sync2 : STD_LOGIC;
  signal data_sync3 : STD_LOGIC;
  signal data_sync4 : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_GmiiToRgmiiCore_resets is
  port (
...
end GmiiToRgmiiCore_GmiiToRgmiiCore_resets;

architecture STRUCTURE of GmiiToRgmiiCore_GmiiToRgmiiCore_resets is
...
idelayctrl_reset_gen: entity work.GmiiToRgmiiCore_GmiiToRgmiiCore_reset_sync
     port map (
      clk => CLK,
      reset_in => reset,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_MANAGEMENT is
  port (
...
end GmiiToRgmiiCore_MANAGEMENT;

architecture STRUCTURE of GmiiToRgmiiCore_MANAGEMENT is
...
MDIO_INTERFACE_1: entity work.GmiiToRgmiiCore_MDIO_INTERFACE
     port map (
      DUPLEX_MODE_REG => \^duplex_mode_reg\,
...
SYNC_MDC: entity work.GmiiToRgmiiCore_sync_block
     port map (
      MDC_REG3 => MDC_REG3,
...
SYNC_MDIO_IN: entity work.GmiiToRgmiiCore_sync_block_5
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_gmii_to_rgmii_core is
  port (
...
end GmiiToRgmiiCore_gmii_to_rgmii_core;

architecture STRUCTURE of GmiiToRgmiiCore_gmii_to_rgmii_core is
  signal D1 : STD_LOGIC;
  signal D2 : STD_LOGIC;
  signal data_out : STD_LOGIC;
...
i_reset_sync_rx_reset: entity work.GmiiToRgmiiCore_reset_sync_2
     port map (
      CLK => \^gmii_rx_clk\,
      reset_in => reset_in,
      reset_out => rx_reset_sync_11
    );
i_reset_sync_tx_reset: entity work.GmiiToRgmiiCore_reset_sync_3
     port map (
      gmii_tx_clk => gmii_tx_clk,
      reset_out => tx_reset_sync_5,
      tx_reset_async_reg => tx_reset_async_reg
    );
i_sync_rx_dv: entity work.\GmiiToRgmiiCore_sync_block__parameterized1\
     port map (
      data_in => gmii_rx_dv_reg_int,
      data_out => data_out,
      gmii_tx_clk => gmii_tx_clk
    );
i_sync_rx_er: entity work.\GmiiToRgmiiCore_sync_block__parameterized1_4\
     port map (
      D1 => D1,
      DUPLEX_MODE_REG => DUPLEX_MODE_REG,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_gmii_to_rgmii_gen is
  port (
    gmii_crs : out STD_LOGIC;
    gmii_rx_clk : out STD_LOGIC;
    rgmii_tx_ctl : out STD_LOGIC;
...
end GmiiToRgmiiCore_gmii_to_rgmii_gen;

architecture STRUCTURE of GmiiToRgmiiCore_gmii_to_rgmii_gen is
  signal DUPLEX_MODE_REG : STD_LOGIC;
...
begin
  \speed_mode[1]\ <= \^speed_mode[1]\;
i_MANAGEMENT: entity work.GmiiToRgmiiCore_MANAGEMENT
     port map (
      DUPLEX_MODE_REG => DUPLEX_MODE_REG,
      mdio_gem_i => mdio_gem_i,
      mdio_gem_mdc => mdio_gem_mdc,
...
i_gmii_to_rgmii: entity work.GmiiToRgmiiCore_gmii_to_rgmii_core
     port map (
      DUPLEX_MODE_REG => DUPLEX_MODE_REG,
      \SPEED_SELECTION_REG_reg[1]\ => \^speed_mode[1]\,
...
i_reset_sync_mgmt_reset: entity work.GmiiToRgmiiCore_reset_sync
     port map (
      ref_clk => ref_clk,
      reset_in => reset_in,
      reset_out => reset_to_mgmt_sync
    );
i_reset_sync_rx_reset: entity work.GmiiToRgmiiCore_reset_sync_0
     port map (
      ref_clk => ref_clk,
      reset_in => reset_in,
...
i_reset_sync_tx_reset: entity work.GmiiToRgmiiCore_reset_sync_1
     port map (
      ref_clk => ref_clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_gmii_to_rgmii_v4_0_6 is
  port (
    tx_reset : in STD_LOGIC;
    rx_reset : in STD_LOGIC;
    ref_clk : in STD_LOGIC;
  ...
  attribute C_DEVICE_TYPE of GmiiToRgmiiCore_gmii_to_rgmii_v4_0_6 : entity is 0;
  attribute C_PHYADDR : string;
  attribute C_PHYADDR of GmiiToRgmiiCore_gmii_to_rgmii_v4_0_6 : entity is "5'b01000";
  attribute C_RGMII_TXC_ODELAY_VAL : integer;
  attribute C_RGMII_TXC_ODELAY_VAL of GmiiToRgmiiCore_gmii_to_rgmii_v4_0_6 : entity is 0;
  attribute C_RGMII_TXC_SKEW_EN : integer;
  attribute C_RGMII_TXC_SKEW_EN of GmiiToRgmiiCore_gmii_to_rgmii_v4_0_6 : entity is 0;
end GmiiToRgmiiCore_gmii_to_rgmii_v4_0_6;

architecture STRUCTURE of GmiiToRgmiiCore_gmii_to_rgmii_v4_0_6 is
...
i_gmii_to_rgmii: entity work.GmiiToRgmiiCore_gmii_to_rgmii_gen
     port map (
      clock_speed(1 downto 0) => clock_speed(1 downto 0),
      duplex_status => duplex_status,
      gmii_col => gmii_col,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_GmiiToRgmiiCore_block is
  port (
    speed_mode : out STD_LOGIC_VECTOR ( 1 downto 0 );
    gmii_crs : out STD_LOGIC;
    gmii_col : out STD_LOGIC;
...
end GmiiToRgmiiCore_GmiiToRgmiiCore_block;

architecture STRUCTURE of GmiiToRgmiiCore_GmiiToRgmiiCore_block is
  signal I : STD_LOGIC;
  ...
  signal NLW_GmiiToRgmiiCore_core_mdio_phy_mdc_UNCONNECTED : STD_LOGIC;
  signal NLW_GmiiToRgmiiCore_core_mdio_phy_o_UNCONNECTED : STD_LOGIC;
  signal NLW_GmiiToRgmiiCore_core_mdio_phy_t_UNCONNECTED : STD_LOGIC;
  attribute C_DEVICE_TYPE : integer;
  attribute C_DEVICE_TYPE of GmiiToRgmiiCore_core : label is 0;
  attribute C_PHYADDR : string;
  attribute C_PHYADDR of GmiiToRgmiiCore_core : label is "5'b01000";
  attribute C_RGMII_TXC_ODELAY_VAL : integer;
  attribute C_RGMII_TXC_ODELAY_VAL of GmiiToRgmiiCore_core : label is 0;
  attribute C_RGMII_TXC_SKEW_EN : integer;
  attribute C_RGMII_TXC_SKEW_EN of GmiiToRgmiiCore_core : label is 0;
  attribute XILINX_LEGACY_PRIM : string;
...
GmiiToRgmiiCore_core: entity work.GmiiToRgmiiCore_gmii_to_rgmii_v4_0_6
     port map (
      clock_speed(1 downto 0) => clock_speed(1 downto 0),
      duplex_status => duplex_status,
      gmii_col => gmii_col,
      ...
      mdio_gem_t => '0',
      mdio_phy_i => mdio_phy_i,
      mdio_phy_mdc => NLW_GmiiToRgmiiCore_core_mdio_phy_mdc_UNCONNECTED,
      mdio_phy_o => NLW_GmiiToRgmiiCore_core_mdio_phy_o_UNCONNECTED,
      mdio_phy_t => NLW_GmiiToRgmiiCore_core_mdio_phy_t_UNCONNECTED,
      ref_clk => ref_clk_out,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GmiiToRgmiiCore_GmiiToRgmiiCore_support is
  port (
    tx_reset : in STD_LOGIC;
    rx_reset : in STD_LOGIC;
    clkin : in STD_LOGIC;
...
end GmiiToRgmiiCore_GmiiToRgmiiCore_support;

architecture STRUCTURE of GmiiToRgmiiCore_GmiiToRgmiiCore_support is
  signal \^gmii_clk_125m_out\ : STD_LOGIC;
  signal \^gmii_clk_25m_out\ : STD_LOGIC;
  signal \^gmii_clk_2_5m_out\ : STD_LOGIC;
  signal i_GmiiToRgmiiCore_clocking_n_0 : STD_LOGIC;
  ...
  signal NLW_i_GmiiToRgmiiCore_idelayctrl_RDY_UNCONNECTED : STD_LOGIC;
  attribute box_type : string;
  attribute box_type of i_GmiiToRgmiiCore_idelayctrl : label is "PRIMITIVE";
begin
  \^mdio_gem_mdc\ <= mdio_gem_mdc;
  \^mdio_gem_o\ <= mdio_gem_o;
...
i_GmiiToRgmiiCore_clocking: entity work.GmiiToRgmiiCore_GmiiToRgmiiCore_clocking
     port map (
      clkin => clkin,
      ...
      gmii_clk_2_5m_out => \^gmii_clk_2_5m_out\,
      mmcm_locked_out => mmcm_locked_out,
      tx_reset => i_GmiiToRgmiiCore_clocking_n_0,
      tx_reset_0 => tx_reset
    );
i_GmiiToRgmiiCore_idelayctrl: unisim.vcomponents.IDELAYCTRL
    generic map(
      SIM_DEVICE => "7SERIES"
    )
        port map (
      RDY => NLW_i_GmiiToRgmiiCore_idelayctrl_RDY_UNCONNECTED,
      REFCLK => \^ref_clk_out\,
      RST => idelayctrl_reset_i
    );
i_GmiiToRgmiiCore_resets: entity work.GmiiToRgmiiCore_GmiiToRgmiiCore_resets
     port map (
      CLK => \^ref_clk_out\,
...
i_gmii_to_rgmii_block: entity work.GmiiToRgmiiCore_GmiiToRgmiiCore_block
     port map (
      clock_speed(1 downto 0) => clock_speed(1 downto 0),
      duplex_status => duplex_status,
      gmii_clk_125m_out => \^gmii_clk_125m_out\,
...
entity GmiiToRgmiiCore is
  ...
  attribute NotValidForBitStream of GmiiToRgmiiCore : entity is true;
  attribute x_core_info : string;
  attribute x_core_info of GmiiToRgmiiCore : entity is "gmii_to_rgmii_v4_0_6,Vivado 2018.2";
end GmiiToRgmiiCore;

architecture STRUCTURE of GmiiToRgmiiCore is
begin
U0: entity work.GmiiToRgmiiCore_GmiiToRgmiiCore_support
     port map (
      clkin => clkin,
      clock_speed(1 downto 0) => clock_speed(1 downto 0),
      duplex_status => duplex_status,
